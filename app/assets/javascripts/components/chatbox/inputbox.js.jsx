          ...
          <div className="col-lg-12">
              <div className="form-chat">
                  <div className="input-group">
                      <input type='text' ref='message_text' name='message_text' placeholder='Введите текст сообщения' className='form-control'/>
                      <span className='input-group-btn'>
                        <button onClick={this.submitForm} className='btn btn-default glyphicon glyphicon-envelope'></button>
                      </span>
                    <input type='hidden' name='authenticity_token' value={this.props.authenticity_token}/>
                  </div>
              </div>
